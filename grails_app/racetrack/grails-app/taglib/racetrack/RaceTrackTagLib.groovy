...
/**
 * Outputs the given <code>Date</code> object in the
 * specified format. If the <code>date</code> is not given,
 * then the current date/time is used. If the
 * <code>format</code> option is not given, then the date is
 * output using the default format.
 *
 * e.g.:
 ...
 * <code>format</code> option is not given, then the number
 * is output using the default format.
 *
 * e.g.:
