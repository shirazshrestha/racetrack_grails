...
${hasErrors(bean:registration,field:'name','errors')}'>
                ...
                <tr class='prop'>
                    ...
                    <td valign='top'
                        class='value
${hasErrors(bean:registration,field:'dateOfBirth','errors')}'>
...
${hasErrors(bean:registration,field:'gender','errors')}'>
                ...
                <tr class='prop'>
                    ...
                    <td valign='top' class='value ${hasErrors(bean:registration,field:'postalAddress','errors')}'>
                        <textarea rows='3' cols='30' name='postalAddress'> ${registration?.postalAddress}
                        </textarea>
                    </td>
                </tr>
                <tr class='prop'>
                    ...
                    <td valign='top' class='value ${hasErrors(bean:registration,field:'emailAddress','errors')}'>
                        <input type="text" maxlength='50' name='emailAddress' value='${registration?.emailAddress}'></input>
                    </td>
                </tr>
            </table>
        </div>
   ...
   <input type="button" value="Cancel"  onClick="history.back()" class="formbutton">
   </input>
   </div>
    </g:form>
</div>
