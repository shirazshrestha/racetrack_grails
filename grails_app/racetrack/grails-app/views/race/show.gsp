...
<div id="show-race" class="content scaffold-show" role="main">
    ...
    <ol class="property-list race">
        ...
        <g:if test="${raceInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${raceInstance}"
                                                                                        field="name"/></span>
        ...
        <g:if test="${raceInstance?.startDateTime}">
            <li class="fieldcontain">
                <span id="startDateTime-label" class="property-label"><g:message code="race.startDateTime.label"
                                                                                 default="Start Date Time"/></span>

                <span class="property-value" aria-labelledby="startDateTime-label"><g:formatDate
                        date="${raceInstance?.startDateTime}"/></span>
        ...
        <g:if test="${raceInstance?.city}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="city-label"><g:fieldValue bean="${raceInstance}"
                                                                                        field="city"/></span>
        ...
        <g:if test="${raceInstance?.state}">
            <li class="fieldcontain">
                <span id="state-label" class="property-label"><g:message code="race.state.label"
                                                                         default="State"/></span>

                <span class="property-value" aria-labelledby="state-label"><g:fieldValue bean="${raceInstance}"
                                                                                         field="state"/></span>
        ...
        <g:if test="${raceInstance?.distance}">
            <li class="fieldcontain">
                <span id="distance-label" class="property-label"><g:message code="race.distance.label"
                                                                            default="Distance"/></span>


                <span class="property-value" aria-labelledby="distance-label"> <g:formatNumber number="${raceInstance.distance}" format="##0.0 mi"/></span>
            </li>
        </g:if>
        ...
        <g:if test="${raceInstance?.maxRunners}">
            <li class="fieldcontain">
                <span id="maxRunners-label" class="property-label"><g:message code="race.maxRunners.label"
                                                                              default="Max Runners"/></span>
        ...
        <g:if test="${raceInstance?.registrations}">
            <li class="fieldcontain">
                <span id="registrations-label" class="property-label"><g:message code="race.registrations.label"
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${raceInstance?.id}"><g:message code="default.button.edit.label"
                                                                                   default="Edit"/></g:link>
            <g:actionSubmit class="delete" action="delete"
                            value="${message(code: 'default.button.delete.label', default: 'Delete')}"
                            onclick="return warnBeforeRaceDelete();"/>
        </fieldset>
    </g:form>
</div>
</body>
