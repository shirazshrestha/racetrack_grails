	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="search" action="search">Search for Races</g:link> </li>
				<li><g:link class="logout" action="logout" controller="user">Log Out</g:link> </li>
			...
			<table>
				...
				<g:each in="${raceInstanceList}" status="i" var="raceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: raceInstance, field: "cost")}
